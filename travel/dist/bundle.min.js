...
function action(event) {
    ...
    .then(function(u) {
       ...
       const a =  getWeatherbit(city_lat , city_lng , cityv)
        console.log(u)
        postData("/add" , {cityv , leve , datv , countryName:u.geonames[0].countryName , lng:u.geonames[0].lng , lat:u.geonames[0].lat , weather:a.currently.summary});
        UI();
    })
}
